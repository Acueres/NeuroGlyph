...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PREDICTREPLY']._serialized_end=283
  _globals['_COMPILERSERVICE']._serialized_start=286
  _globals['_COMPILERSERVICE']._serialized_end=461
